...
// Função para formatar a descrição, adicionando negrito aos termos entre asteriscos
function formatDescription(description) {
  // Substitui os asteriscos pelas tags <strong>
...
function addImageClickEvents() {
  ...
  images.forEach(img => {
    img.addEventListener("click", function () {
      ...
      const caption = formatDescription(description) || this.alt; 
